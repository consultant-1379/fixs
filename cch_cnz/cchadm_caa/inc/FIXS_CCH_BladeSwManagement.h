/*
 * FIXS_CCH_BladeSwManagement.h
 *
 *  Created on: Apr 4, 2012
 *      Author: eanform
 */

#ifndef FIXS_CCH_BLADESWMANAGEMENT_H_
#define FIXS_CCH_BLADESWMANAGEMENT_H_
...
class FIXS_CCH_ThreadActions;

class FIXS_CCH_BladeSwManagement: public acs_apgcc_objectimplementerinterface_V3 {
public:

	FIXS_CCH_BladeSwManagement();

	virtual ~FIXS_CCH_BladeSwManagement();
...
private:
	...
	FIXS_CCH_ThreadActions* importSw;

	SaAisErrorT checkParams(ACS_APGCC_AdminOperationParamType**paramList, int& fbn, std::string& path, int& error);

	void importSwPackage(ACS_APGCC_OiHandle oiHandle, ACS_APGCC_InvocationType invocation, ACS_APGCC_AdminOperationParamType**paramList);
};


#endif /* FIXS_CCH_BLADESWMANAGEMENT_H_ */
