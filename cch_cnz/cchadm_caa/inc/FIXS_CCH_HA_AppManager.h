#ifndef FIXS_CCH_HA_APPMANAGER_H
#define FIXS_CCH_HA_APPMANAGER_H
...
class FIXS_CCH_HA_AppManager: public ACS_APGCC_ApplicationManager {
   ...
   public:
        FIXS_CCH_HA_AppManager(const char* daemon_name);
        virtual ~FIXS_CCH_HA_AppManager();
