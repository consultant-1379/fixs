...
ACE_thread_mutex_t s_csSmx;
ACE_thread_mutex_t s_csSmx_snmp;
...
struct Lock
{
	Lock()
	{
		//std::cout << "FIXS_CCH_SmxUpgrade: Lock region while exception active." << std::endl;
		ACE_OS::thread_mutex_trylock(&s_csSmx);
	};

	~Lock()
	{
		//std::cout << "FIXS_CCH_SmxUpgrade: Leave Lock region while exception active." << std::endl;
		ACE_OS::thread_mutex_unlock(&s_csSmx);
	};
};
...
struct Lock_snmp
{
	Lock_snmp()
	{
		//std::cout << "FIXS_CCH_SmxUpgrade: SNMP Lock region while exception active." << std::endl;
		ACE_OS::thread_mutex_trylock(&s_csSmx_snmp);
	};

	~Lock_snmp()
	{
		//std::cout << "FIXS_CCH_SmxUpgrade: SNMP Leave Lock region while exception active." << std::endl;
		ACE_OS::thread_mutex_unlock(&s_csSmx_snmp);
	};
};
}
...
namespace {
	...
	const std::string INSTALLATION_FOLDER = "/data/apz/data/boot/SMX/";
...
FIXS_CCH_SmxUpgrade::SmxState::SmxState()
      : m_context(0)
{
	m_id = FIXS_CCH_SmxUpgrade::STATE_UNDEFINED;
	m_set_status = false;
}

FIXS_CCH_SmxUpgrade::SmxState::SmxState (FIXS_CCH_SmxUpgrade::SmxStateId stateId)
      : m_context(0)
{
...
//## Other Operations (implementation)
 void FIXS_CCH_SmxUpgrade::SmxState::setContext (FIXS_CCH_SmxUpgrade* context)
{
 	m_context = context;
}

FIXS_CCH_SmxUpgrade::SmxStateId FIXS_CCH_SmxUpgrade::SmxState::getStateId () const
{
 	return m_id;
}

 int FIXS_CCH_SmxUpgrade::SmxState::activateSW ()
{
 ...
 int FIXS_CCH_SmxUpgrade::SmxState::commit ()
{
	int result = 0;
	//std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << std::endl;
	std::cout << " *********************** WRONG EVENT IN THIS STATE" <<std::endl;
 ...
 int FIXS_CCH_SmxUpgrade::SmxState::prepare (std::string packageToUpgrade, std::string productToUpgrade)
{
 ...
 int FIXS_CCH_SmxUpgrade::SmxState::cancel ()
{
	int result = 0;
	//std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << std::endl;
	std::cout << " *********************** WRONG EVENT IN THIS STATE" <<std::endl;
 ...
 int FIXS_CCH_SmxUpgrade::SmxState::loadReleaseCompleted (int loadResult)
{
 	int result = 0;
	//std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << std::endl;
 ...
 int FIXS_CCH_SmxUpgrade::SmxState::coldStart ()
{
 	int result = 0;
	//std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << std::endl;
	std::cout << " *********************** WRONG EVENT IN THIS STATE" <<std::endl;
...
FIXS_CCH_SmxUpgrade::State_Activated::State_Activated()
 :FIXS_CCH_SmxUpgrade::SmxState(FIXS_CCH_SmxUpgrade::STATE_ACTIVATED)
{
...
//## Other Operations (implementation)
 int FIXS_CCH_SmxUpgrade::State_Activated::commit ()
{
	...
	if (success)
	{
		...
		m_context->setEvent(FIXS_CCH_SmxUpgrade::SMX_COMMIT_RECEIVED);
	}
	else
	{
		...
		//try once again
		m_context->setEvent(FIXS_CCH_SmxUpgrade::SMX_COMMIT_RECEIVED_FAILED);
		
		//????????????
		//m_cont->setEvent(m_events_tab[COMMIT]);
	}
	return result;
}

 int FIXS_CCH_SmxUpgrade::State_Activated::cancel ()
{
	int result = 0;
	...
	else
	{
		...
		//add 1 second sleep to avoid jinitreq to hang in DSD
		//this is temporary work-around to avoid crash in cancel
		sleep(1);

		// Start the Smx Reset
		m_context->resetSwitch();
	
		m_context->setEvent(FIXS_CCH_SmxUpgrade::SMX_CANCEL_RECEIVED);
		result = EXECUTED;
	}
...
FIXS_CCH_SmxUpgrade::State_Activating::State_Activating()
  :FIXS_CCH_SmxUpgrade::SmxState(FIXS_CCH_SmxUpgrade::STATE_ACTIVATING)
{
...
//## Other Operations (implementation)
 int FIXS_CCH_SmxUpgrade::State_Activating::coldStart ()
{
	int res = 0;
	...
	sleep(1); //Smx needs some second to update the MIB
	...
	if (readSuccess)
	{
		...
		sleep(1);
		//activated (new value!)
		m_context->setEvent(FIXS_CCH_SmxUpgrade::SMX_WARMRESTART_NEW_COMPLETED);
		res = EXECUTED;
	}
	else
	{
		...
		{
			char tmpStr[512] = {0};
			snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] Failed: value is not changed, rollback ", __FUNCTION__, __LINE__);
		...
		//in order to cold restart Smx we need to change the state machine by handling a new state logic to 
		...
		m_context->setEvent(FIXS_CCH_SmxUpgrade::SMX_WARMRESTART_OLD_COMPLETED);
...
FIXS_CCH_SmxUpgrade::State_Automatic_Rollback_Ended::State_Automatic_Rollback_Ended()
  :FIXS_CCH_SmxUpgrade::SmxState(FIXS_CCH_SmxUpgrade::STATE_AUTOMATIC_ROLLBACK_ENDED)
{
}
...
//## Other Operations (implementation)
 int FIXS_CCH_SmxUpgrade::State_Automatic_Rollback_Ended::commit ()
{
  	int result = 0;
...
FIXS_CCH_SmxUpgrade::State_Manual_Rollback_Ended::State_Manual_Rollback_Ended()
  :FIXS_CCH_SmxUpgrade::SmxState(FIXS_CCH_SmxUpgrade::STATE_MANUAL_ROLLBACK_ENDED)
{
}
...
//## Other Operations (implementation)
 int FIXS_CCH_SmxUpgrade::State_Manual_Rollback_Ended::commit ()
{
  	int result = 0;
...
FIXS_CCH_SmxUpgrade::State_Idle::State_Idle()
  :FIXS_CCH_SmxUpgrade::SmxState(FIXS_CCH_SmxUpgrade::STATE_IDLE)
{
}
...
//## Other Operations (implementation)
 int FIXS_CCH_SmxUpgrade::State_Idle::prepare (std::string packageToUpgrade, std::string productToUpgrade)
{
  	/*
	...
	*/
	...
	{
		result = m_context->setEvent(FIXS_CCH_SmxUpgrade::SMX_PREPARE_RECEIVED);
		result = EXECUTED;
	}
...
FIXS_CCH_SmxUpgrade::State_Preparing::State_Preparing()
  :FIXS_CCH_SmxUpgrade::SmxState(FIXS_CCH_SmxUpgrade::STATE_PREPARING)
{
}
...
//## Other Operations (implementation)
 int FIXS_CCH_SmxUpgrade::State_Preparing::cancel ()
{
	int result = 0;
 ...
 int FIXS_CCH_SmxUpgrade::State_Preparing::loadReleaseCompleted (int loadResult)
{
  	int result = 0;
	...
	{
		//ok
		m_context->setEvent(FIXS_CCH_SmxUpgrade::SMX_PREPARE_OK);
		result = EXECUTED;
	...
	else
	{
		...
		else
		{
			...
			m_context->setEvent(FIXS_CCH_SmxUpgrade::SMX_FAILURE_RECEIVED);
...
FIXS_CCH_SmxUpgrade::State_Prepared::State_Prepared()
  :FIXS_CCH_SmxUpgrade::SmxState(FIXS_CCH_SmxUpgrade::STATE_PREPARED)
{
}
...
//## Other Operations (implementation)
 int FIXS_CCH_SmxUpgrade::State_Prepared::cancel ()
{
	int result = 0;
 ...
 int FIXS_CCH_SmxUpgrade::State_Prepared::activateSW ()
{
	...
	if (startReqStatus == false)
	{
		std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " ++START REQ FALSE++" << std::endl;
	...
	else if (m_context->startRelease())
	{
		...
		m_context->maintenanceWindow(FIXS_CCH_JTPHandler::IMBSW_START_UPGRADE);
		result = m_context->setEvent(FIXS_CCH_SmxUpgrade::SMX_ACTIVATE_RECEIVED);
	}
	else
	{
		result = SNMP_FAILURE; //13
...
FIXS_CCH_SmxUpgrade::State_Manual_Rollback_Ongoing::State_Manual_Rollback_Ongoing()
  :FIXS_CCH_SmxUpgrade::SmxState(FIXS_CCH_SmxUpgrade::STATE_MANUAL_ROLLBACK_ONGOING)
{
}
...
//## Other Operations (implementation)
 int FIXS_CCH_SmxUpgrade::State_Manual_Rollback_Ongoing::coldStart ()
{
...
FIXS_CCH_SmxUpgrade::State_Failed::State_Failed()
  :FIXS_CCH_SmxUpgrade::SmxState(FIXS_CCH_SmxUpgrade::STATE_FAILED)
{
}
...
//## Other Operations (implementation)
 int FIXS_CCH_SmxUpgrade::State_Failed::prepare (std::string packageToUpgrade, std::string productToUpgrade)
{
  	bool success = false;
	int result = 0;
...
FIXS_CCH_SmxUpgrade::EventQueue::EventQueue()
     : m_queueHandle(-1)
{
	//Lock lock;
...
//## Other Operations (implementation)
FIXS_CCH_SmxUpgrade::SmxEventId FIXS_CCH_SmxUpgrade::EventQueue::getFirst ()
{
	//FIXS_CCH_CriticalSectionGuard eventLock(m_queueCriticalSection);
	//Lock lock;

	SmxEventId result = SMX_DEFAULT_NO_EVENT;
 ...
 void FIXS_CCH_SmxUpgrade::EventQueue::popData ()
{
//	 FIXS_CCH_CriticalSectionGuard eventLock(m_queueCriticalSection);
	 //Lock lock;
 ...
 void FIXS_CCH_SmxUpgrade::EventQueue::pushData (FIXS_CCH_SmxUpgrade::SmxEventId info)
{
//	 FIXS_CCH_CriticalSectionGuard eventLock(m_queueCriticalSection);
	 //Lock lock;

	 {
		 ...
		 {
			 //check first element
			 FIXS_CCH_SmxUpgrade::SmxEventId first;
			 first = getFirst();
 ...
 bool FIXS_CCH_SmxUpgrade::EventQueue::queueEmpty ()
{
	 //Lock lock;
 ...
 size_t FIXS_CCH_SmxUpgrade::EventQueue::queueSize ()
{
	 //Lock lock;
...
FIXS_CCH_SmxUpgrade::SmxEventId FIXS_CCH_SmxUpgrade::EventQueue::getItem (int index)
{

	//Lock lock;

	std::list<SmxEventId>::iterator it = m_qEventInfo.begin();
	while (index-- && (it != m_qEventInfo.end())) ++it;

	if (it == m_qEventInfo.end())
		return SMX_DEFAULT_NO_EVENT;
	else
		return *it;

}

void FIXS_CCH_SmxUpgrade::EventQueue::cleanQueue()
{
	while (!m_qEventInfo.empty()) {
		m_qEventInfo.pop_front();
	}
...
FIXS_CCH_SmxUpgrade::FIXS_CCH_SmxUpgrade()
      : trapTimer(NULL),
        m_exit(false),
        m_running(false),
        m_lastErrorCode(0),
...
/*
	...
	if (traceObj->ACS_TRA_ON())
	{
		...
		snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] "
			"Hostname: %s ", __FUNCTION__, __LINE__, apHostName.c_str() );
		traceObj->ACS_TRA_event(1,tmpStr);
	}

	if (apHostName.length() > 0)
	{
		m_APNode = apHostName.substr(apHostName.length() -1, 1);
	}
	else
	{
		m_APNode = "";
...
FIXS_CCH_SmxUpgrade::FIXS_CCH_SmxUpgrade (unsigned short boardId, unsigned long magazine, unsigned short slot, std::string installedPackage, std::string Smx_IP_EthA, std::string Smx_IP_EthB, std::string dn)
	:trapTimer(NULL), m_exit(false), m_running(false),
	 m_lastErrorCode(0),
	 m_upgradeStatus(0),
	 m_fullUpradeType(false),
	 m_eventQueue(),
	 m_slot(slot), m_magazine(magazine), m_boardId(boardId), m_Smx_IP_EthA(Smx_IP_EthA), m_Smx_IP_EthB(Smx_IP_EthB), m_currentCxp(installedPackage), m_expectedCxp(""),m_Object_DN(dn)
	 ,m_active_commit(0)
{
	...
	m_Smx_IP = m_Smx_IP_EthA;

	traceObj = new ACS_TRA_trace("FIXS_CCH_SmxUpgrade");
	...
	//m_neighborSmxIP = "";
	if (!IMM_Interface::getNeighborSmxIp(m_Object_DN,m_slot,m_neighborSmxIPA, m_neighborSmxIPB)) {m_neighborSmxIPA = "";m_neighborSmxIPB = "";}

	m_currentCxc.clear();
	m_currentCxc = FIXS_CCH_SoftwareMap::getInstance()->getSoftwareProduct(installedPackage);

	m_previouSmxp = m_currentCxp;
...
FIXS_CCH_SmxUpgrade::~FIXS_CCH_SmxUpgrade()
{
	...
	if (m_jtpHandler[1])
	{
		if (m_jtpHandler[1]->isRunningThread())	m_jtpHandler[1]->stop();
	}
...
//	}
 ...
 int FIXS_CCH_SmxUpgrade::activateSW ()
{
...
//  	std::cout << "DBG:####################### " << __FUNCTION__ << "@" << __LINE__ << " m_currentState->get() " << getStateName().c_str()<< std::endl;
 ...
 int FIXS_CCH_SmxUpgrade::commit ()
{
...
int FIXS_CCH_SmxUpgrade::prepare (std::string packageToUpgrade, std::string productToUpgrade)
{
 ...
 int FIXS_CCH_SmxUpgrade::setEvent (FIXS_CCH_SmxUpgrade::SmxEventId event)
{
 ...
 int FIXS_CCH_SmxUpgrade::open (void *args)
 {
	 int result = 0;
	 UNUSED(args);
	 ...
	 {//log
		 char traceChar[512] = {0};
		 snprintf(traceChar, sizeof(traceChar) - 1,"SMX UPGRADE Starting thread on instance [%p]. \n",this);
...
//	const int Stop_Event_Index=3;
	...
	while ( ! m_exit ) // Set to true when the thread shall exit
	{
		...
		case WAIT_FAILED:   // Event failed
			{
				...
				//std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " SmxUpgrade WAIT_FAILED... GetLastError() == " << GetLastError() << std::endl;
				if (traceObj->ACS_TRA_ON())
				{
					char tmpStr[512] = {0};
			...
			{
				//std::cout << __FUNCTION__ << "@" << __LINE__ << " SmxUpgrade is waiting for events..." << std::endl;
				if (traceObj->ACS_TRA_ON())
				{
					char tmpStr[512] = {0};
			...
			{
				std::cout << __FUNCTION__ << "@" << __LINE__ << " SmxUpgrade Shutdown_Event_Index..." << std::endl;
				if (traceObj->ACS_TRA_ON())
				{
					char tmpStr[512] = {0};
		...
		case (WAIT_OBJECT_0 + Command_Event_Index):    // Command ready to be handled
			{
				//std::cout << __FUNCTION__ << "@" << __LINE__ << " SmxUpgrade Command_Event_Index => handleCommandEvent()" << std::endl;
				printMachineInfo(m_magazine, m_slot, getStateName());

				if (traceObj->ACS_TRA_ON())
				{
					char tmpStr[512] = {0};
					snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] SmxUpgrade Command_Event_Index => handleCommandEvent()", __FUNCTION__, __LINE__);
					traceObj->ACS_TRA_event(1,tmpStr);
					if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_DEBUG);
				}
...
//				if (m_eventQueue.queueEmpty())
		...
		case (WAIT_OBJECT_0 + (TimeoutTrap_Event_Index)):
			{
				std::cout << __FUNCTION__ << "@" << __LINE__ << " SMXUpgrade TimeoutTrap_Event_Index => handleTrapTimeout()" << std::endl;

				if (traceObj->ACS_TRA_ON())
				{
					char tmpStr[512] = {0};
					snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] SMX Upgrade TimeoutTrap_Event_Index on event:[%d]", __FUNCTION__, __LINE__,m_timeoutTrapEvent);
					traceObj->ACS_TRA_event(1,tmpStr);
					if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_DEBUG);
				}
...
//		{
//			std::cout << __FUNCTION__ << "@" << __LINE__ << " SmxUpgrade Stop_Event_Index" << std::endl;
//
//
//			{
//				char tmpStr[512] = {0};
//				snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] SmxUpgrade Stop_Event_Index", __FUNCTION__, __LINE__);
//				if (traceObj->ACS_TRA_ON())traceObj->ACS_TRA_event(1,tmpStr);
//				if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_DEBUG);
//			}
//
...
//		}
	...
	{
		char tmpStr[512] = {0};
		snprintf(tmpStr, sizeof(tmpStr) - 1, "FIXS_CCH_SmxUpgrade [%s@%d] Exiting from while", __FUNCTION__, __LINE__);
		if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_DEBUG);
		if (traceObj->ACS_TRA_ON())traceObj->ACS_TRA_event(1,tmpStr);
	}
 ...
 void FIXS_CCH_SmxUpgrade::stop ()
 {
	 m_exit = true;

	 {//log
		 char traceChar[512] = {0};
		 snprintf(traceChar, sizeof(traceChar) - 1,"Smx UPGRADE Stopping thread on instance [%p]. \n",this);
		 if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(traceChar,LOG_LEVEL_DEBUG);
		 if (traceObj->ACS_TRA_ON())traceObj->ACS_TRA_event(1,traceChar);
	 }
...
//	 }
 ...
 void FIXS_CCH_SmxUpgrade::handleCommandEvent ()
 {
	 ...
	 while (!m_eventQueue.queueEmpty()) {
		 ...
		 FIXS_CCH_SmxUpgrade::SmxEventId qEventInfo = SMX_DEFAULT_NO_EVENT;
...
void FIXS_CCH_SmxUpgrade::handleTrapTimeout ()
{

	std::string expectedSoftware("SMX_");
	...
	if (getStateName() == "PREPARING") // timer on loadreleasecomplete
	{
		...
		m_snmpManager = new FIXS_CCH_SNMPManager(m_Smx_IP_EthA);
		...
		do{
			...
			{
				m_snmpManager->setIpAddress(m_Smx_IP_EthB);
				countFlag++;
			}
			else
			{
	...
	else if (getStateName() == "ACTIVATING") // timer on cold start
	{
		...
		if (m_jtpHandler[1])m_jtpHandler[1]->maintenanceWindow(FIXS_CCH_JTPHandler::IMBSW_END_UPGRADE);
		...
		else
		{
			...
			setEvent(FIXS_CCH_SmxUpgrade::SMX_WARMRESTART_OLD_COMPLETED);
	...
	else if (getStateName() == "MANUAL_ROLLBACK_ONGOING") // timer on cold start
	{
		...
		else
		{
			...
			//version didn't rollback
			setEvent(FIXS_CCH_SmxUpgrade::SMX_FAILURE_RECEIVED);
		}
 ...
 bool FIXS_CCH_SmxUpgrade::cancelTrapTimer ()
{
 ...
 bool FIXS_CCH_SmxUpgrade::startTrapTimer (int seconds)
{
...
//		return false;
 ...
 void FIXS_CCH_SmxUpgrade::initOnStart ()
{
...
//		m_StopEvent=FIXS_CCH_Event::OpenNamedEvent(eventNameStop);
 ...
 void FIXS_CCH_SmxUpgrade::switchState (FIXS_CCH_SmxUpgrade::SmxEventId eventId)
{
...
//	int lastReason = 0;
	...
	switch(eventId)
	{
		case SMX_PREPARE_RECEIVED:
			t_event = "SMX_PREPARE_RECEIVED";
			break;

		case SMX_ACTIVATE_RECEIVED:
			t_event = "SMX_ACTIVATE_RECEIVED";
			break;

		case SMX_COMMIT_RECEIVED:
			t_event = "SMX_COMMIT_RECEIVED";
			break;

		case SMX_CANCEL_RECEIVED:
			t_event = "SMX_CANCEL_RECEIVED";
			break;

		case SMX_PREPARE_OK:
			t_event = "SMX_PREPARE_OK";
			break;
		
		case SMX_WARMRESTART_NEW_COMPLETED:
			t_event = "SMX_WARMRESTART_NEW_COMPLETED";
			break;

		case SMX_WARMRESTART_OLD_COMPLETED:
			t_event = "SMX_WARMRESTART_OLD_COMPLETED";
			break;
		
		case SMX_COMMIT_OK:
			t_event = "SMX_COMMIT_OK";
			break;
		
		case SMX_FAILURE_RECEIVED:
			t_event = "SMX_FAILURE_RECEIVED";
			break;

		case SMX_ROLLBACK_OK:
			t_event = "SMX_ROLLBACK_OK";
			break;

		case SMX_DEFAULT_NO_EVENT:
			t_event = "SMX_DEFAULT_NO_EVENT";
			break;
	...
	switch(m_currentState->getStateId())
	{
		...
		case STATE_IDLE:
			switch(eventId)
			{
				case SMX_PREPARE_RECEIVED: // IDLE, SMX_PREPARE_RECEIVED == > PREPARING
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " IDLE: SMX_PREPARE_RECEIVED == > PREPARING "<<std::endl;

					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] IDLE: SMX_PREPARE_RECEIVED == > PREPARING ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_INFO);
					}
		...
		case STATE_PREPARING:
			switch(eventId)
			{
				case SMX_PREPARE_OK: // PREPARING: SMX_PREPARE_OK == > PREPARED
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " PREPARING: SMX_PREPARE_OK == > PREPARED"<<std::endl;
					
					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] PREPARING: SMX_PREPARE_OK == > PREPARED ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_INFO);
					}
				...
				case SMX_CANCEL_RECEIVED: // PREPARING: SMX_CANCEL_RECEIVED == > MANUAL_ROLLBACK_ENDED
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " PREPARING: SMX_CANCEL_RECEIVED == > MANUAL_ROLLBACK_ENDED "<<std::endl;
					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] PREPARING: SMX_CANCEL_RECEIVED == > MANUAL_ROLLBACK_ENDED ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_INFO);
					}
				...
				case SMX_FAILURE_RECEIVED: // PREPARING: SMX_FAILURE_RECEIVED == > AUTOMATIC_ROLLBACK_ENDED
					
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " PREPARING: SMX_FAILURE_RECEIVED == > AUTOMATIC_ROLLBACK_ENDED "<<std::endl;
					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] PREPARING: SMX_FAILURE_RECEIVED == > AUTOMATIC_ROLLBACK_ENDED ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_INFO);
					}
					cancelTrapTimer();
		...
		case STATE_PREPARED:
			switch(eventId)
			{
				case SMX_ACTIVATE_RECEIVED: // PREPARED: SMX_ACTIVATE_RECEIVED == > ACTIVATING
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " PREPARED: SMX_ACTIVATE_RECEIVED == > ACTIVATING"<<std::endl;
					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] PREPARED: SMX_ACTIVATE_RECEIVED == > ACTIVATING ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_INFO);
					}
				...
				case SMX_CANCEL_RECEIVED: // PREPARED: SMX_CANCEL_RECEIVED == > MANUAL ROLL BACK ENDED
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " PREPARED: SMX_CANCEL_RECEIVED == > MANUAL ROLL BACK ENDED"<<std::endl;
					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] PREPARED: SMX_CANCEL_RECEIVED == > MANUAL ROLL BACK ENDED ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_INFO);
					}
		...
		case STATE_ACTIVATING:
			switch(eventId)
			{
				case SMX_WARMRESTART_NEW_COMPLETED: // ACTIVATING: SMX_WARMRESTART_NEW_COMPLETED == > ACTIVATED
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " ACTIVATING: SMX_WARMRESTART_NEW_COMPLETED == > ACTIVATED"<<std::endl;
					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] ACTIVATING: SMX_WARMRESTART_NEW_COMPLETED == > ACTIVATED ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_INFO);
					}
				...
				case SMX_WARMRESTART_OLD_COMPLETED: // ACTIVATING: SMX_WARMRESTART_NEW_COMPLETED == > AUTOMATIC_ROLLBACK_ONGOING
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " ACTIVATING: SMX_WARMRESTART_NEW_COMPLETED == > AUTOMATIC_ROLLBACK_Ended "<<std::endl;
					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] ACTIVATING: SMX_WARMRESTART_NEW_COMPLETED == > AUTOMATIC_ROLLBACK_Ended ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_INFO);
					}
		...
		case STATE_ACTIVATED:
			switch(eventId)
			{
				case SMX_COMMIT_RECEIVED: // ACTIVATED: SMX_COMMIT_RECEIVED == > IDLE
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " ACTIVATED: SMX_COMMIT_RECEIVED == > IDLE"<<std::endl;
					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] ACTIVATED: SMX_COMMIT_RECEIVED == > IDLE ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_INFO);
					}
				...
				//	IMM_Interface::updateUsedPackage(m_magazine,m_slot,m_previouSmxp,getExpectedCXP());
					...
					FIXS_CCH_UpgradeManager::getInstance()->checkSMXswVr();
				...
				case SMX_COMMIT_RECEIVED_FAILED: // ACTIVATED: SMX_COMMIT_RECEIVED_FAILED == > SW_ERR_COMMIT_ERROR
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " ACTIVATED: SMX_COMMIT_RECEIVED_FAILED == > SW_ERR_COMMIT_ERROR"<<std::endl;
					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] ACTIVATED: SMX_COMMIT_RECEIVED_FAILED == > SW_ERR_COMMIT_ERROR ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_INFO);
					}
				...
				case SMX_CANCEL_RECEIVED: // ACTIVATED: SMX_CANCEL_RECEIVED == > MANUAL ROLL BACK ONGOING
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " ACTIVATED: SMX_CANCEL_RECEIVED == > MANUAL ROLL BACK ONGOING"<<std::endl;
					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] ACTIVATED: SMX_CANCEL_RECEIVED == > MANUAL ROLL BACK ONGOING ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_INFO);
					}
		...
		case STATE_MANUAL_ROLLBACK_ONGOING:
			switch(eventId)
			{
				case SMX_WARMRESTART_OLD_COMPLETED: // MANUAL_ROLLBAK_ONGOING: SMX_ROLLBACK_OK == > MANUAL_ROLLBAK_ENDED
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " MANUAL_ROLLBAK_ONGOING: SMX_ROLLBACK_OK == > MANUAL_ROLLBAK_ENDED"<<std::endl;
					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] MANUAL_ROLLBAK_ONGOING: SMX_ROLLBACK_OK == > MANUAL_ROLLBAK_ENDED ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_INFO);
					}
				...
				case SMX_FAILURE_RECEIVED: // MANUAL_ROLLBAK_ONGOING: SMX_FAILURE_RECEIVED == > FAILED
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " MANUAL_ROLLBAK_ONGOING: SMX_FAILURE_RECEIVED == > FAILED"<<std::endl;
					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] MANUAL_ROLLBAK_ONGOING: SMX_FAILURE_RECEIVED == > FAILED ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_ERROR);
					}
...
//					m_currentState = &m_failed;
		...
		case STATE_MANUAL_ROLLBACK_ENDED:
			switch(eventId)
			{
				case SMX_COMMIT_RECEIVED: // MANUAL_ROLLBAK_END: SMX_COMMIT_RECEIVED == > IDLE
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " MANUAL_ROLLBACK_END: SMX_COMMIT_RECEIVED == > IDLE"<<std::endl;
					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] MANUAL_ROLLBACK_END: SMX_COMMIT_RECEIVED == > IDLE ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_INFO);
					}
					m_currentState = &m_idle;
...
//					status = CCH_Util::SW_ERR_OK;
		...
		case STATE_AUTOMATIC_ROLLBACK_ENDED:
			switch(eventId)
			{
				case SMX_COMMIT_RECEIVED: // AUTOMATIC_ROLLBAK_END: SMX_COMMIT_RECEIVED == > IDLE
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " AUTOMATIC_ROLLBAK_END: SMX_COMMIT_RECEIVED == > IDLE"<<std::endl;
					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] AUTOMATIC_ROLLBAK_END: SMX_COMMIT_RECEIVED == > IDLE ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_DEBUG);
					}
					m_currentState = &m_idle;
...
//					status = CCH_Util::SW_ERR_OK;
		...
		case STATE_FAILED:
			switch(eventId)
			{
				case SMX_PREPARE_RECEIVED: // FAILED, SMX_PREPARE_RECEIVED == > PREPARING
					std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " FAILED: SMX_PREPARE_RECEIVED == > PREPARING "<<std::endl;

					if (traceObj->ACS_TRA_ON())
					{
						char tmpStr[512] = {0};
						snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] FAILED: SMX_PREPARE_RECEIVED == > PREPARING ", __FUNCTION__, __LINE__);
						traceObj->ACS_TRA_event(1,tmpStr);
						if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_ERROR);
					}
 ...
 int FIXS_CCH_SmxUpgrade::cancel ()
{
//
//	 std::cout << "DBG:####################### " << __FUNCTION__ << "@" << __LINE__ << " m_currentState->get() " << getStateName().c_str()<< std::endl;
	 if (strcmp(m_SwInventory_Object_DN.c_str(),"") == 0 )
 ...
 std::string FIXS_CCH_SmxUpgrade::getStateName ()
{
	std::string t_currState="";
 ...
 bool FIXS_CCH_SmxUpgrade::configureDHCP (bool rollback)
{
...
//	CCH_Util::findAndReplace(magazine,".","_");
 ...
 bool FIXS_CCH_SmxUpgrade::preliminaryCheckOnPrepare (std::string softwareVersion, std::string containerId)
{

	bool result = true;
	std::string currCXC("");
	currCXC = ACS_APGCC::after(this->m_currentCxc,"SMX_");
	//if (this->m_currentCxp == containerId)
 ...
 FIXS_CCH_SmxUpgrade::SmxStateId FIXS_CCH_SmxUpgrade::getStateId () const
{
  	return m_currentState->getStateId();
}

 bool FIXS_CCH_SmxUpgrade::loadRelease ()
{
	...
	do  // if the first snmp statement fails, trying second one
	{
		...
		//url = "tftp://192.168."+ sub + ".33/Smx/"+ getExpectedCXP();
		
		std::string folder = INSTALLATION_FOLDER + getExpectedCXP();
		
		//todo
		Smxfilename=getSmxFileName(m_expectedCxp);

//		Smxfilename = "Smx3.tar";
		
		//url = "tftp://192.168."+ sub + ".33/Smx/"+ getExpectedCXP() + "/" + Smxfilename;

		if (m_APNode.length() <= 0)
		{
			//Old method
			url = "tftp://192.168."+ sub + ".33/boot/SMX/"+ getExpectedCXP() + "/" + Smxfilename;
		}
		else
		{
			if (m_APNode == "A")
			{
				url = "tftp://192.168."+ sub + ".1/boot/SMX/"+ getExpectedCXP() + "/" + Smxfilename;
			}
			else if (m_APNode == "B")
			{
				url = "tftp://192.168."+ sub + ".2/boot/SMX/"+ getExpectedCXP() + "/" + Smxfilename;
			}
			else
			{
				if (traceObj->ACS_TRA_ON())
	...
	if (result)
	{
		...
		m_snmpManager->setIpAddress(m_Smx_IP_EthA);
 ...
 int FIXS_CCH_SmxUpgrade::loadReleaseCompleted (int loadResult)
{
 	int res=0;
 ...
 bool FIXS_CCH_SmxUpgrade::checkLoadedVersion ()
{
 ...
 bool FIXS_CCH_SmxUpgrade::checkCurrentLoadedVersion ()
{
	...
	int countFlag=0;
	string ipadd("");
	std::string productExpected("SMX_");
 ...
 int FIXS_CCH_SmxUpgrade::coldStart ()
{
	int res=0;
//	std::cout << "DBG:####################### " << __FUNCTION__ << "@" << __LINE__ << " m_currentState->get() " << getStateName().c_str()<< std::endl;
	{ //log
 ...
 void FIXS_CCH_SmxUpgrade::maintenanceWindow (unsigned char msgType)
 {
 ...
 bool FIXS_CCH_SmxUpgrade::readActionStatus ()
{
	...
	do {
		...
		else if (countFlag == 0)
		{
			...
			{
				char tmpStr[512] = {0};
				snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] Error reading Action status - switching IP Address(%s) "
						, __FUNCTION__, __LINE__, m_snmpManager->getIpAddress().c_str());
				if (traceObj->ACS_TRA_ON())traceObj->ACS_TRA_event(1,tmpStr);
				if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_ERROR);
			}
		...
		else
		{
			...
			{
				char tmpStr[512] = {0};
				snprintf(tmpStr, sizeof(tmpStr) - 1, "[%s@%d] Error reading action status "
					, __FUNCTION__, __LINE__);
				traceObj->ACS_TRA_event(1,tmpStr);
				if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(tmpStr,LOG_LEVEL_ERROR);
			}
 ...
 bool FIXS_CCH_SmxUpgrade::startRelease ()
{
	...
	do  // if the first snmp statement fails, trying second one
	{
		std::string version = "SMX_" + getExpectedCXC();
 ...
 bool FIXS_CCH_SmxUpgrade::makeDefault ()
{
 ...
 void FIXS_CCH_SmxUpgrade::resetSwitch ()
 {

	 FIXS_CCH_SNMPManager * m_snmpManager = NULL;

	 // reset switch can only be issued on the Smx Master because
	 // the reset OID belongs to the IPMI MIB

	 int countFlag = 0;
	 m_snmpManager = new FIXS_CCH_SNMPManager(m_Smx_IP_EthA);
	 std::string ipAddress = m_Smx_IP_EthA;

	 do{
		 int resMaster = m_snmpManager->isMaster(ipAddress);
		 if (resMaster == 1)//master
		 {
			 m_snmpManager->resetSwitch(m_slot); // cold restart SmxB
			 { //trace


				 {
					 char traceChar[256] = {0};
					 unsigned long hlmag = ntohl(this->m_magazine);
					 unsigned char u_plug0 = (unsigned char)(hlmag >> 24);
					 unsigned char mag = u_plug0 & 0x0F;
					 snprintf(traceChar, sizeof(traceChar) - 1, "[%s@%d][MAG:%x, SLOT:%u] Cold restart SmxB through resetSwitch", __FUNCTION__, __LINE__, mag, m_slot);
					 if (traceObj->ACS_TRA_ON())traceObj->ACS_TRA_event(1,traceChar);
					 if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(traceChar,LOG_LEVEL_DEBUG);
				 }
		 ...
		 else if (resMaster == 2) //passive
		 {
			 std::string m_neighborSmxIP = m_neighborSmxIPA;
			 m_snmpManager->setIpAddress(m_neighborSmxIPA);

			 //issue the reset on the master Smx
			 if (!m_snmpManager->resetSwitch(m_slot))
			 {
				 m_snmpManager->setIpAddress(m_neighborSmxIPB);
				 m_neighborSmxIP = m_neighborSmxIPB;
				 m_snmpManager->resetSwitch(m_slot);
			 }
			 ...
			 { //trace

				 {
					 ...
					 unsigned char u_plug0 = (unsigned char)(hlmag >> 24);
					 unsigned char mag = u_plug0 & 0x0F;
					 snprintf(traceChar, sizeof(traceChar) - 1, "[%s@%d][MAG:%x, SLOT:%u] This is a passive Smx, the resetSwitch is going through neighbor address %s",
							 __FUNCTION__, __LINE__, mag, m_slot, m_neighborSmxIP.c_str());
					 if (traceObj->ACS_TRA_ON())traceObj->ACS_TRA_event(1,traceChar);
					 if(FIXS_CCH_logging)  FIXS_CCH_logging->Write(traceChar,LOG_LEVEL_DEBUG);
				 }
 ...
 void FIXS_CCH_SmxUpgrade::saveStatus ()
{
 ...
 void FIXS_CCH_SmxUpgrade::onRestart ()
{
	...
	if (getStateName() == "PREPARING" )
	{
		...
		if (checkResult)
		{
			// success
			std::cout << "DBG: " << __FUNCTION__ << "@" << __LINE__ << " checkLoadedVersion(" << expectedSoftware.c_str() << ") SUCCESS!!!" << std::endl;
			setEvent(FIXS_CCH_SmxUpgrade::SMX_PREPARE_OK);
		}
		else
		{
			// failed
...
//		if (m_jtpHandler[1]) m_jtpHandler[1]->open();
		...
		if (checkCurrentLoadedVersion())
		{
			...
			setEvent(FIXS_CCH_SmxUpgrade::SMX_WARMRESTART_NEW_COMPLETED);
		}
		else
		{
			startTrapTimer(TEN_MINUTES);
...
//		if (m_jtpHandler[1]) m_jtpHandler[1]->open();
 ...
 void FIXS_CCH_SmxUpgrade::getOverallStatus (CCH_Util::SWData &swdata)
{
 ...
 void FIXS_CCH_SmxUpgrade::restoreStatus (CCH_Util::SWData &swdata)
{
 ...
 std::string FIXS_CCH_SmxUpgrade::getCurrentRunningSoftware ()
{
 ...
 bool FIXS_CCH_SmxUpgrade::readResultStatus ()
{
 ...
 bool FIXS_CCH_SmxUpgrade::checkRollBackVersion ()
{
	...
	while (!exit)
	{
		if (m_snmpManager->getCurrentLoadedVersion(SmxVer))
		{
			std::cout << __FUNCTION__ << "@" << __LINE__ << 
			" - checkRollBackVersion: " << SmxVer << 
			" - expectedSoftware: " << expectedSoftware << std::endl;
			
			exit = true;
				if (SmxVer.compare(expectedSoftware) != 0 )
				{
					//true
					result = true;
 ...
 bool FIXS_CCH_SmxUpgrade::checkCurrentDefaultVersion ()
{
	
	FIXS_CCH_SNMPManager * m_snmpManager = NULL;

	std::string currLoadVer("");
	std::string currentSoftware("SMX_");
 ...
 bool FIXS_CCH_SmxUpgrade::restoreMakeDefault ()
 {
 ...
 void FIXS_CCH_SmxUpgrade::setObjectDN(const char* dn)
 {
	 m_Object_DN = dn;
 }

 void FIXS_CCH_SmxUpgrade::setSwInvObjectDN(std::string dn)
 {
	 //m_SwInventory_Object_DN = dn.c_str();
	 m_SwInventory_Object_DN = dn;
 }

 std::string FIXS_CCH_SmxUpgrade::getSwInvObjectDN()
 {
	 return m_SwInventory_Object_DN;
 }

 std::string FIXS_CCH_SmxUpgrade::getSwPercistanceDN()
 {
	 return dn_blade_persistance;
 }

 bool FIXS_CCH_SmxUpgrade::modifySwInventory(int state)
 {
	 int lastResult = 0;
	 int lastReason = 0;
	 std::string lastDate("");
	 ...
	 currSw = ACS_APGCC::after(m_currentCxc,"SMX_");
 ...
 bool FIXS_CCH_SmxUpgrade::initSwInventory()
 {
	 int currState = this->getStateId();
 ...
 int FIXS_CCH_SmxUpgrade::getStateImm ()
 {
	 int t_currState = -1;
 	switch(getStateId())
 	{
 ...
 std::string  FIXS_CCH_SmxUpgrade::getSmxFileName( std::string package)
 {
	 std::string fileName("");
...
void FIXS_CCH_SmxUpgrade::resetEvents ()
{
	FIXS_CCH_Event::ResetEvent(m_cmdEvent);
	FIXS_CCH_Event::ResetEvent(m_timeoutTrapEvent);
...
bool FIXS_CCH_SmxUpgrade::sendStartRequestToCP (bool & shutdownsignaled)
{
...
void FIXS_CCH_SmxUpgrade::WaitJtpNotificationRetriesToFinish()
{
