...
CXC_NAME ?= FIXS_TREFCBIN
CXC_NAME_PATH ?= trefc_cxc
...
CXC_OLD_VER ?= 
CXC_VER ?= R1H
BLOCK_NAME = FIXS_TREFCBIN
CXC_BLK_NAME?=fixs_trefc
FX_CLEAN_TMP := rm -rf /tmp/$(USER)/*
BASE_SW_VER ?= 3.6.0-R1A

LIBAPI_DIR = $(CNZ_PATH)/trefc_cxc/bin/lib_ext
LIBAPI_EXT_DIR = $(CNZ_PATH)/trefc_cxc/bin/lib_ext
LIBAPI_INT_DIR = $(CNZ_PATH)/trefc_cxc/bin/lib_int
