#ifndef FIXS_TREFC_HA_APPMANAGER_H
#define FIXS_TREFC_HA_APPMANAGER_H
...
class FIXS_TREFC_HA_AppManager: public ACS_APGCC_ApplicationManager {
   ...
   public:
        FIXS_TREFC_HA_AppManager(const char* daemon_name);
        virtual ~FIXS_TREFC_HA_AppManager();
   ...
   private:
        ...
        FIXS_TREFC_Server *startSRV;
        ACS_TRA_Logging *FIXS_TREFC_logging;
