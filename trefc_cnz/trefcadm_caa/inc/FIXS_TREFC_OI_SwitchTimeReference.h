/*
 * FIXS_TREFC_OI_SwitchTimeReference.h
 *
 *  Created on: Jul 10, 2012
 *      Author: eanform
 */

#ifndef FIXS_TREFC_OI_SWITCHTIMEREFERENCE_H_
#define FIXS_TREFC_OI_SWITCHTIMEREFERENCE_H_
...
=================================================================== */
class FIXS_TREFC_OI_SwitchTimeReference : public acs_apgcc_objectimplementerinterface_V2
{
 public:

	/**		@brief	constructor
	*/
	FIXS_TREFC_OI_SwitchTimeReference();

	/**		@brief	destructor
	*/
	virtual ~FIXS_TREFC_OI_SwitchTimeReference();
...
#endif /* FIXS_TREFC_OI_SWITCHTIMEREFERENCE_H_ */
