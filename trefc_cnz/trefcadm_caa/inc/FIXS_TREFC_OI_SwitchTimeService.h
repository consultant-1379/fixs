/*
 * FIXS_TREFC_OI_SwitchTimeService.h
 *
 *  Created on: Jan 3, 2012
 *      Author: eanform
 */

#ifndef FIXS_TREFC_OI_SwitchTimeService_H_
#define FIXS_TREFC_OI_SwitchTimeService_H_
...
=================================================================== */
class FIXS_TREFC_OI_SwitchTimeService : public acs_apgcc_objectimplementerinterface_V2
{
 public:

	/**		@brief	constructor
	*/
	FIXS_TREFC_OI_SwitchTimeService();

	/**		@brief	destructor
	*/
	virtual ~FIXS_TREFC_OI_SwitchTimeService();
...
#endif /* FIXS_TREFC_OI_SwitchTimeService_H_ */
