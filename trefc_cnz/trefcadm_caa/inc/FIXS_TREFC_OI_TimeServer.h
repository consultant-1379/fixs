/*
 * FIXS_TREFC_OI_TimeServer.h
 *
 *  Created on: Jan 3, 2012
 *      Author: eanform
 */

#ifndef FIXS_TREFC_OI_TIMESERVER_H_
#define FIXS_TREFC_OI_TIMESERVER_H_
...
=================================================================== */
class FIXS_TREFC_OI_TimeServer : public acs_apgcc_objectimplementerinterface_V2
{
 public:

	/**		@brief	constructor
	*/
	//FIXS_TREFC_OI_TimeServer(string implName, FIXS_CCH_CmdHandler* cmdHandler);
	FIXS_TREFC_OI_TimeServer();

	/**		@brief	destructor
	*/
	virtual ~FIXS_TREFC_OI_TimeServer();
 ...
 private:
	...
	std::map <ACS_APGCC_CcbId, std::vector<TimeServerAction> > transaction;

	void addToTransaction (ACS_APGCC_CcbId ccbid, TimeServer server, IMM_Util::Action action);
...
#endif /* FIXS_TREFC_OI_TIMESERVER_H_ */
