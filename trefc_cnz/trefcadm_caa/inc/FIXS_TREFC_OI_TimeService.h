/*
 * FIXS_TREFC_OI_TimeService.h
 *
 *  Created on: Jan 3, 2012
 *      Author: eanform
 */

#ifndef FIXS_TREFC_OI_TIMESERVICE_H_
#define FIXS_TREFC_OI_TIMESERVICE_H_
...
//class ACS_TRA_trace;
class FIXS_TREFC_ThreadActions;

/*===================================================================
                        CLASS DECLARATION SECTION
=================================================================== */
class FIXS_TREFC_OI_TimeService : public acs_apgcc_objectimplementerinterface_V2
{
 public:

//	/**		@brief	constructor
//	*/
//	//FIXS_TREFC_OI_TimeService(string implName, FIXS_CCH_CmdHandler* cmdHandler);
//	FIXS_TREFC_OI_TimeService();
//
//	/**		@brief	destructor
//	*/
//	virtual ~FIXS_TREFC_OI_TimeService();
	...
	static  FIXS_TREFC_OI_TimeService* getInstance ();

	void finalize();

 private:

	static FIXS_TREFC_OI_TimeService* m_instance;
	/** @brief m_className
	 *
	...
	FIXS_TREFC_ThreadActions* m_actionThread;
...
#endif /* FIXS_TREFC_OI_TIMESERVICE_H_ */
